...
#install ss
declare -a pkgs=("pi-core" "pi-apps/image" "pi-apps/leds" "pi-apps/br" "pi-apps/inf" "pi-apps/status" "pi-apps/debug" "pi-web/neo_plot" "pi-web/hist_plot" "pi-web/inf_gui" "pi-web/labeler" "pi-svc/audio_playback")
for i in "${pkgs[@]}"
do
